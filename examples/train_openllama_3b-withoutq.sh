...
python -m EasyLM.models.llama.llama_train \
    ...
    --update_llama_config='' \
    --load_dataset_state='' \
    --load_checkpoint='trainstate_params::gs://jsg-bucket/LLM/easyLM/llama2_3b/experiment_output/llama3-log/d7fc158c2214470c97eaa0344582462c/streaming_train_state' \
