...
python -m EasyLM.models.llama.llama_train \
    ...
    --update_llama_config='' \
    --load_dataset_state='' \
    --load_checkpoint='trainstate_params::gs://jsg-bucket/LLM/easyLM/llama2_3b/experiment_output/llama3-log/592b47394afe4166badf74e82dce1327/streaming_train_state' \
