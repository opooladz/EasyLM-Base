...
python -m EasyLM.models.llama.llama_train \
    ...
    --update_llama_config='' \
    --load_dataset_state='' \
    --load_checkpoint='trainstate_params::gs://jsg-bucket/LLM/easyLM/llama2_3b/experiment_output/llama3-log/52d7602c3a2e4fb19050c5ff5df12aac/streaming_train_state' \
